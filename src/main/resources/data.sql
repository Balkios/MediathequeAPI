...
insert into DOCUMENT (TITRE, NBRE_EXEMPLAIRES, DATE_PARUTION, DISPONIBLE) values ('CD2', 5, '1977-08-15',true);

insert into DOCUMENT (TITRE, NBRE_EXEMPLAIRES, DATE_PARUTION, DISPONIBLE) values ('DVD1', 7, '1987-06-28',true);
insert into DOCUMENT (TITRE, NBRE_EXEMPLAIRES, DATE_PARUTION, DISPONIBLE) values ('DVD2', 9, '1987-11-08',true);

insert into DOCUMENT (TITRE, NBRE_EXEMPLAIRES, DATE_PARUTION, DISPONIBLE) values ('livre1', 11, '2016-06-28',true);
insert into DOCUMENT (TITRE, NBRE_EXEMPLAIRES, DATE_PARUTION, DISPONIBLE) values ('livre2', 13, '2017-11-08',true);


insert into DOCUMENT (TITRE, NBRE_EXEMPLAIRES, DATE_PARUTION, DISPONIBLE) values ('livre new 1', 11, '2022-03-15',true);
insert into DOCUMENT (TITRE, NBRE_EXEMPLAIRES, DATE_PARUTION, DISPONIBLE) values ('CD new 1', 13, '2022-02-28',true);
insert into DOCUMENT (TITRE, NBRE_EXEMPLAIRES, DATE_PARUTION, DISPONIBLE) values ('DVD new 1', 11, '2022-03-22',true);
